<?php
    ...
    if($action == 'add_project'){
        ...
        if($_POST['iProjectId'] == ''){
            ...
            $sql = "SELECT vOwnProjectId FROM projects WHERE 1=1 ORDER BY iProjectId DESC LIMIT 0,1";
            $db_projectid_det = $obj->MySQLSelect($sql);
            
            if($db_projectid_det[0]['vOwnProjectId'] < 400){
                $Data['vOwnProjectId'] = 400;
            }else{
               $Data['vOwnProjectId'] = 400+1;
            }
